...
#define NXPBUILD__PHPAL_SLI15693_SW
#if defined (NXPBUILD__PHPAL_SLI15693_SW)
    #define NXPBUILD__PHPAL_SLI15693             /**< Generic PAL MIFARE definition */
#endif
...
#define NXPBUILD__PHAL_I15693_SW
#if defined (NXPBUILD__PHAL_I15693_SW)
    #define NXPBUILD__PHAL_I15693                /**< Generic AL Tag Operations */
#endif

/* AL Sli components */
#define NXPBUILD__PHAL_SLI_SW

#if defined (NXPBUILD__PHAL_SLI_SW)
    #define NXPBUILD__PHAL_SLI                 /**< Generic AL Tag Operations */
#endif
